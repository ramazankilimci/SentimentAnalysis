...
# To bypass ssl certificate control, use below try else function(Lines: 16-24).
# try:
...
# For first time use, nltk.download() must be executed(Line:24). Required packages must be installed.
# nltk.download()
